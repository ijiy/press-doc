import{_ as s,c as a,a0 as p,o as l}from"./chunks/framework.Bakaa70P.js";const m=JSON.parse('{"title":"ESLint格式化 【.eslintrc】","description":"","frontmatter":{},"headers":[],"relativePath":"convention/eslintrc.md","filePath":"convention/eslintrc.md","lastUpdated":1715407916000}'),e={name:"convention/eslintrc.md"};function t(r,n,i,c,b,u){return l(),a("div",null,n[0]||(n[0]=[p(`<h1 id="eslint格式化-【-eslintrc】" tabindex="-1">ESLint格式化 【.eslintrc】 <a class="header-anchor" href="#eslint格式化-【-eslintrc】" aria-label="Permalink to &quot;ESLint格式化 【.eslintrc】&quot;">​</a></h1><ul><li><a href="https://eslint.org/docs/rules" target="_blank" rel="noreferrer">eslint convention</a></li></ul><h2 id="eslint有争议的规则" tabindex="-1">ESLint有争议的规则 <a class="header-anchor" href="#eslint有争议的规则" aria-label="Permalink to &quot;ESLint有争议的规则&quot;">​</a></h2><ul><li><p>no-magic-numbers, 禁用魔术数字 (建议用常量声明数字, 并注释该数字含义)</p></li><li><p>guard-for-in, 遍历要排除原型链继承来的属性 (很多情况并没必要, 反而影响性能)</p></li></ul><div class="language-js line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai vp-code" tabindex="0"><code><span class="line"><span style="color:#66D9EF;font-style:italic;">const</span><span style="color:#F8F8F2;"> obj </span><span style="color:#F92672;">=</span><span style="color:#F8F8F2;"> {a: </span><span style="color:#AE81FF;">1</span><span style="color:#F8F8F2;">, b: </span><span style="color:#AE81FF;">2</span><span style="color:#F8F8F2;">};</span></span>
