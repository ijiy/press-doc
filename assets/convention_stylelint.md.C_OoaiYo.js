import{_ as s,c as n,o as a,a1 as l}from"./chunks/framework.B3EJgH_4.js";const m=JSON.parse('{"title":"Stylelint格式化 【.stylelintrc】","description":"","frontmatter":{},"headers":[],"relativePath":"convention/stylelint.md","filePath":"convention/stylelint.md","lastUpdated":1707209816000}'),p={name:"convention/stylelint.md"},e=l(`<h1 id="stylelint格式化-【-stylelintrc】" tabindex="-1">Stylelint格式化 【.stylelintrc】 <a class="header-anchor" href="#stylelint格式化-【-stylelintrc】" aria-label="Permalink to &quot;Stylelint格式化 【.stylelintrc】&quot;">​</a></h1><ul><li>.stylelintrc.cjs</li></ul><div class="language-js line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai vp-code"><code><span class="line"><span style="color:#66D9EF;font-style:italic;">module</span><span style="color:#F8F8F2;">.</span><span style="color:#66D9EF;font-style:italic;">exports</span><span style="color:#F92672;"> =</span><span style="color:#F8F8F2;"> {</span></span>
