import{_ as s,c as n,o as a,a1 as p}from"./chunks/framework.B3EJgH_4.js";const m=JSON.parse('{"title":"uniapp 【manifest】","description":"","frontmatter":{},"headers":[],"relativePath":"uniapp/manifest.md","filePath":"uniapp/manifest.md","lastUpdated":1705132275000}'),l={name:"uniapp/manifest.md"},t=p(`<h1 id="uniapp-【manifest】" tabindex="-1">uniapp 【manifest】 <a class="header-anchor" href="#uniapp-【manifest】" aria-label="Permalink to &quot;uniapp 【manifest】&quot;">​</a></h1><h2 id="manifest-json-app-plus-配置" tabindex="-1"><code>manifest.json</code> -&gt; <code>app-plus</code> 配置 <a class="header-anchor" href="#manifest-json-app-plus-配置" aria-label="Permalink to &quot;\`manifest.json\` -&gt; \`app-plus\` 配置&quot;">​</a></h2><div class="language-json5 line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json5</span><pre class="shiki monokai vp-code"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
