import{_ as s,c as n,o as a,a1 as l}from"./chunks/framework.B3EJgH_4.js";const m=JSON.parse('{"title":"popover","description":"","frontmatter":{},"headers":[],"relativePath":"webs/ui-library/element/popover.md","filePath":"webs/ui-library/element/popover.md","lastUpdated":1711102103000}'),p={name:"webs/ui-library/element/popover.md"},e=l(`<h1 id="popover" tabindex="-1">popover <a class="header-anchor" href="#popover" aria-label="Permalink to &quot;popover&quot;">​</a></h1><ul><li><code>v-if</code>要在<code>&lt;el-popover&gt;</code>上, 而不是<code>reference</code>的元素上</li></ul><div class="language-vue line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki monokai vp-code"><code><span class="line"><span style="color:#F8F8F2;">&lt;</span><span style="color:#F92672;">el-popover</span></span>
