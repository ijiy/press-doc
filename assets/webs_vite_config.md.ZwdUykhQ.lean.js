import{_ as n,c as a,a0 as l,o as p}from"./chunks/framework.Bakaa70P.js";const y=JSON.parse('{"title":"vite 【配置】","description":"","frontmatter":{},"headers":[],"relativePath":"webs/vite/config.md","filePath":"webs/vite/config.md","lastUpdated":1694342534000}'),e={name:"webs/vite/config.md"};function o(t,s,r,c,i,F){return p(),a("div",null,s[0]||(s[0]=[l(`<h1 id="vite-【配置】" tabindex="-1">vite 【配置】 <a class="header-anchor" href="#vite-【配置】" aria-label="Permalink to &quot;vite 【配置】&quot;">​</a></h1><p>vite.config.ts</p><h2 id="读取环境" tabindex="-1">读取环境 <a class="header-anchor" href="#读取环境" aria-label="Permalink to &quot;读取环境&quot;">​</a></h2><div class="language-js line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai vp-code" tabindex="0"><code><span class="line"><span style="color:#F92672;">import</span><span style="color:#F8F8F2;"> {</span></span>
